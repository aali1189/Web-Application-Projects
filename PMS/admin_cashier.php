...
<html>
<head>
<title><?php echo $username;?>Pharmacy Managemnt System</title>
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td>&nbsp;&nbsp;&nbsp;<a href="update_cashier.php?username=<?php echo $row['username']?>"><i class="fa fa-edit fa-2x" style="color:green"></i></a></td>
				<td>&nbsp;&nbsp;&nbsp;<a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><i class="fa fa-trash fa-2x" style="color:red"></i></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
