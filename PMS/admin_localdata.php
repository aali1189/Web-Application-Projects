...
?>
	   ...
	   if($selected_val=="Fullerton")
				   $result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Fullerton' ")or die(mysqli_error());
		if($selected_val=="Michikan")
				   $result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Michikan' ")or die(mysqli_error());
		if($selected_val=="Newark")
				   $result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Newark' ")or die(mysqli_error());
		if($selected_val=="Ladora")
       			$result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Ladora' ")or die(mysqli_error());		   
