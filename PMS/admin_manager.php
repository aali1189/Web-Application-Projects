    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td>&nbsp;&nbsp;&nbsp;<a href="update_manager.php?username=<?php echo $row['username']?>"><i class="fa fa-edit fa-2x" style="color:green"></i></td>
				<td>&nbsp;&nbsp;&nbsp;<a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><i class="fa fa-trash fa-2x" style="color:red"></i></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
