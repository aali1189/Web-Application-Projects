...
$sql=mysqli_query($con, "INSERT INTO stock_np(drug_name,category,description,company,supplier,city,quantity,cost,status,date_supplied)
VALUES('$sname','$cat','$des','$com','$sup','$city','$qua','$cost','$sta',NOW())");

$sql=mysqli_query($con, "INSERT INTO stock_dr(drug_name,category,description,company,supplier,city,quantity,cost,status,date_supplied)
VALUES('$sname','$cat','$des','$com','$sup','$city','$qua','$cost','$sta',NOW())");

$sql=mysqli_query($con, "INSERT INTO stock_ca(drug_name,category,description,company,supplier,city,quantity,cost,status,date_supplied)
VALUES('$sname','$cat','$des','$com','$sup','$city','$qua','$cost','$sta',NOW())");
...
<?php echo $message;
		...
		*/
		...
		$result = mysqli_query($con, "SELECT * FROM stock_np UNION ALL SELECT * FROM stock_ca UNION ALL SELECT * FROM stock_dr  order by stock_id")  or die(mysqli_error());
