...
if($_POST['originLocationCode'] != null && $_POST['destinationLocationCode'] != null){
   ...
   $Airport = new Airports();
    ...
    ?>
<div class="panel panel-primary Carriers">
   <ul>
       
           <?php
    $CICON = json_encode($Obj->dictionaries->carriers);
    for($C=0; $C<strlen($CICON); $C++){
        
        if($CICON[$C] == ":"){ ?>
    
       <li>
        <img src="https://daisycon.io/images/airline/?width=200&height=80&iata=<?php echo $CICON[$C-3] . $CICON[$C-2]; ?>" />
       </li>       
     <?php } } ?>
...
//                }
       ...
       <div class="panel-heading row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 Airline-logo">
            <img src="https://daisycon.io/images/airline/?width=150&height=150&iata=<?php echo $Obj->data[$i]->validatingAirlineCodes[0]; ?>">
           </div>
    ...
    <div class="row">
       ...
       <li class="Traveler-type">
        ...
        <?php if($Obj->data[$i]->travelerPricings[0]->fareDetailsBySegment[0]->includedCheckedBags->weight>1) {?>
        <li class="Traveler-type">
        <i style="color:#4caf50" class="fas fa-suitcase"></i><span> <?php echo $Obj->data[$i]->travelerPricings[0]->fareDetailsBySegment[0]->includedCheckedBags->weight; ?>  
